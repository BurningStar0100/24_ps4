...
#
# Download pretrained and nakal model weights
#
WEIGHTS_PATH = experiments/nakal_weights
...
NAKAL_HTML = $(WEIGHTS_PATH)/nakal_large_structure.pt
NAKAL_BBOX = $(WEIGHTS_PATH)/nakal_large_bbox.pt
NAKAL_CELL = $(WEIGHTS_PATH)/nakal_large_content.pt
...
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/vqvae_1m.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/vqvae_2m.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/ssp_1m_base.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/ssp_1m_large.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/ssp_2m_base.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/ssp_2m_large.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/nakal_large_structure.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/nakal_large_bbox.pt -P $(WEIGHTS_PATH)
> wget -c https://huggingface.co/BurningStar/nakal/resolve/main/nakal_large_content.pt -P $(WEIGHTS_PATH)
> $(info Completed!)
endif
